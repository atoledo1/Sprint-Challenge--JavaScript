...
const displayNames =zooAnimals.map((information)=>{
  return {Name:information.animal_name,Scientific:information.scientific_name};
})
...
*/
const lowPopulationAnimals = zooAnimals.filter(function(name){
